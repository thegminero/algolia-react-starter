...
export default function CategoryMenu(){
    ...
    return <>
            <button id="multiLevelDropdownButton" data-dropdown-toggle="dropdown" className={`text-white ${color}-700 hover:${color}-800 focus:ring-4 focus:outline-none focus:ring-${color}-300 font-medium rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center`} type="button">Dropdown button <svg className="w-4 h-4 ml-2" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7"></path></svg></button>
